const demoPresets = [
  {
    id: "rect-9x4",
    kind: "image",
    src: "assets/research/wiki/tiling-array-web.jpg",
  ...
  },
  {
    id: "circle-100u",
    kind: "image",
    src: "assets/research/wiki/design-zellige-emerald.jpg",
    alt: "A circular aperiodic monotile patch",
    shape: "Circle",
    unit: "100-unit diameter",
    tiles: "~1,036 tiles",
    format: "Production SVG in packs",
  },
  {
    id: "tri-50u",
    kind: "image",
    src: "assets/research/wiki/education-rainbow-ripple.jpg",
  ...
  },
  {
    id: "stl-panel",
    kind: "image",
    src: "assets/research/wiki/computer-graphics-brass.jpg",
    alt: "A flat STL-style aperiodic tiling panel with raised linework",
    shape: "Raised 3D panel",
    unit: "90 x 40 units",
    tiles: "~500 tiles",
    format: "STL in digital packs",
  },
  {
    id: "glb-game",
    kind: "image",
    src: "assets/research/wiki/computer-graphics-sunset.jpg",
...
async function initGenerator() {
  ...
  document.querySelectorAll("[data-upgrade-format]").forEach((button) => {
    button.addEventListener("click", () => {
      ...
      if (generatorStatus) {
        generatorStatus.textContent = `${format} exports are paid production geometry. Start with Solo or Pro access below.`;
      }
