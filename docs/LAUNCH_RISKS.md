...
| Email deliverability | Open | `support@aperiodic-monotile.com` must actually receive mail before checkout receipts go to customers; verify with a test purchase. |
